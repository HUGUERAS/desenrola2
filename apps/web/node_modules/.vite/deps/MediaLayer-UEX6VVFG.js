import {
  ...
  n as n6,
  p as p6
} from "./chunk-FVRFTG3Y.js";
import {
  p as p7
} from "./chunk-OLDH52BF.js";
import {
  r as r5
} from "./chunk-LLHFFJAN.js";
import "./chunk-WAGITSWK.js";
import {
  o as o5
} from "./chunk-MME3Z4D2.js";
import "./chunk-IYLZO6WF.js";
import {
  p as p4
} from "./chunk-A3YBSIO5.js";
...
import {
  t
} from "./chunk-GN3U7ENT.js";
import "./chunk-AC23G4UV.js";
import {
  p as p5
} from "./chunk-UKQ2BWNI.js";
import {
  n
...
import {
  b2 as b
} from "./chunk-ZJHSTT6C.js";
import {
  j
} from "./chunk-OGVOWCSG.js";
import {
  l as l3
} from "./chunk-A5UWF6F7.js";
import "./chunk-FWFJGH5K.js";
import {
  p as p3
} from "./chunk-ZUKUBL6I.js";
import "./chunk-U6QATIIU.js";
import "./chunk-2SLWYL7O.js";
import {
  t as t2
} from "./chunk-FDNIDZRO.js";
...
var C = e();
var N2 = n5();
var q = class extends n2 {
};
__decorate([m2({ type: Number, json: { write: { isRequired: true } } })], q.prototype, "x", void 0), __decorate([m2({ type: Number, json: { write: { isRequired: true } } })], q.prototype, "y", void 0), q = __decorate([a("esri.layers.support.ControlPointsGeoreference.ControlPointJSONType")], q);
...
__decorate([m2({ type: [p7], json: { write: { allowNull: false, isRequired: true, target: { controlPoints: { type: [q], isRequired: true }, coefficients: { type: [Number], isRequired: true }, spatialReference: { type: f, isRequired: true } } } } })], T2.prototype, "controlPoints", void 0), __decorate([o("controlPoints")], T2.prototype, "readControlPoints", null), __decorate([r2("controlPoints")], T2.prototype, "writeControlPoints", null), __decorate([m2({ clonable: false })], T2.prototype, "coords", null), __decorate([m2({ type: Number, nonNullable: true, json: { write: { isRequired: true } } })], T2.prototype, "height", void 0), __decorate([m2({ readOnly: true })], T2.prototype, "inverseTransform", null), __decorate([m2({ readOnly: true })], T2.prototype, "transform", null), __decorate([m2({ type: Number, nonNullable: true, json: { write: { isRequired: true } } })], T2.prototype, "width", void 0), T2 = __decorate([a("esri.layers.support.ControlPointsGeoreference")], T2);
var _4 = n5();
var M2 = n5();
var I2 = n5();
var L2 = n5();
...
__decorate([m2({ clonable: false })], y.prototype, "coords", null), __decorate([m2({ type: _2 })], y.prototype, "bottomLeft", void 0), __decorate([m2({ type: _2 })], y.prototype, "bottomRight", void 0), __decorate([m2({ type: _2 })], y.prototype, "topLeft", void 0), __decorate([m2({ type: _2 })], y.prototype, "topRight", void 0), y = __decorate([a("esri.layers.support.CornersGeoreference")], y);
var h = y;
...
__decorate([m2({ clonable: false })], p8.prototype, "coords", null), __decorate([m2({ type: z })], p8.prototype, "extent", void 0), __decorate([m2({ type: Number })], p8.prototype, "rotation", void 0), p8 = __decorate([a("esri.layers.support.ExtentAndRotationGeoreference")], p8);
var u4 = p8;
...
__decorate([m2(h2)], u6.prototype, "georeference", void 0), __decorate([o("georeference")], u6.prototype, "readGeoreference", null), __decorate([r2("georeference")], u6.prototype, "writeGeoreference", null), __decorate([m2({ json: { read: false, write: false } })], u6.prototype, "opacity", void 0), u6 = __decorate([a("esri.layers.support.MediaElementBase")], u6);
...
var E2 = (_a = class extends u6 {
  ...
  writeImage(t3, e3, r6, o6) {
    ...
    if (!n7 || !s5) return void ("string" == typeof t3 && (e3[r6] = m(t3, o6)));
    const a3 = U2(t3) ? t3 : null;
    if (a3) {
      if (null == v(a3)) return void (e3[r6] = a3);
      const t4 = m(a3, { ...o6, verifyItemRelativeUrls: (o6 == null ? void 0 : o6.verifyItemRelativeUrls) ? { writtenUrls: o6.verifyItemRelativeUrls.writtenUrls, rootPath: void 0 } : void 0 }, 1);
...
function P4(t3, e3) {
  const r6 = n(), o6 = `${V("media", r6)}.${p5({ type: "blob", blob: t3 })}`;
  return e3.resourceFromPath(o6);
}
__decorate([m2()], E2.prototype, "animationOptions", void 0), __decorate([m2({ readOnly: true })], E2.prototype, "content", void 0), __decorate([m2({ readOnly: true })], E2.prototype, "contentWidth", null), __decorate([m2({ readOnly: true })], E2.prototype, "contentHeight", null), __decorate([m2(x3)], E2.prototype, "image", void 0), __decorate([o("image", ["url"])], E2.prototype, "readImage", null), __decorate([r2("image")], E2.prototype, "writeImage", null), __decorate([m2(g)], E2.prototype, "type", void 0), E2 = __decorate([a("esri.layers.support.ImageElement")], E2);
...
__decorate([m2()], V3.prototype, "autoplay", void 0), __decorate([m2({ readOnly: true })], V3.prototype, "content", void 0), __decorate([m2({ readOnly: true })], V3.prototype, "contentWidth", null), __decorate([m2({ readOnly: true })], V3.prototype, "contentHeight", null), __decorate([m2({ type: Number })], V3.prototype, "currentTime", null), __decorate([m2({ type: Number })], V3.prototype, "duration", null), __decorate([m2(x3)], V3.prototype, "video", null), __decorate([r2("video")], V3.prototype, "writeVideo", null), __decorate([m2(g)], V3.prototype, "type", void 0), V3 = __decorate([a("esri.layers.support.VideoElement")], V3);
...
__decorate([m2()], I3.prototype, "elements", null), __decorate([m2({ readOnly: true })], I3.prototype, "fullExtent", null), __decorate([m2()], I3.prototype, "spatialReference", null), I3 = __decorate([a("esri.layers.support.LocalMediaElementSource")], I3);
...
var L4 = class extends p3(t2(b(j(l3(b2))))) {
  constructor(e3) {
    super(e3), this.effectiveSource = null, this.georeference = null, this.copyright = null, this.operationalLayerType = "MediaLayer", this.spatialReference = null, this.type = "media", this._debouncedSaveOperations = L(async (e4, r6, o6) => {
      const { save: t3, saveAs: s5 } = await import("./mediaLayerUtils-3FNGKTDE.js");
      switch (e4) {
        case 0:
          return t3(this, r6);
        case 1:
...
__decorate([m2({ readOnly: true })], L4.prototype, "effectiveSource", void 0), __decorate([m2({ readOnly: true, json: { read: false, write: false, origins: { "web-document": { read: true } } } })], L4.prototype, "georeference", void 0), __decorate([o("web-document", "georeference")], L4.prototype, "readGeoreference", null), __decorate([m2({ type: String })], L4.prototype, "copyright", void 0), __decorate([m2({ readOnly: true })], L4.prototype, "fullExtent", null), __decorate([m2({ type: ["MediaLayer"] })], L4.prototype, "operationalLayerType", void 0), __decorate([m2({ type: ["show", "hide"] })], L4.prototype, "listMode", void 0), __decorate([m2({ nonNullable: true, json: { write: { enabled: true, allowNull: false, target: { url: { type: String }, mediaType: { type: ["image", "video"] }, georeference: { type: T2 } }, overridePolicy(e3, r6, o6) {
...
} } } })], L4.prototype, "source", null), __decorate([s3("source")], L4.prototype, "castSource", null), __decorate([o("source", ["url"])], L4.prototype, "readSource", null), __decorate([r2("source")], L4.prototype, "writeSource", null), __decorate([m2()], L4.prototype, "spatialReference", void 0), __decorate([m2({ readOnly: true })], L4.prototype, "type", void 0), L4 = __decorate([a("esri.layers.MediaLayer")], L4);
var O3 = L4;
export {
  O3 as default
};
//# sourceMappingURL=MediaLayer-UEX6VVFG.js.map
