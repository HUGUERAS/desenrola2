...
async function u() {
  if (!s2()) {
    const [e, t] = await Promise.all([import("./OperatorGeodesicBuffer-GIGQZSHL.js"), import("./SpatialReference-UOWTUWWE.js").then(({ injectPe: e2 }) => e2), n()]);
...
//# sourceMappingURL=chunk-MIRUVCAI.js.map
