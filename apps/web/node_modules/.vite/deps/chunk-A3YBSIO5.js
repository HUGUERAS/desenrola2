...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-QZJPXVCS.js");
    if (t3(r)) return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-O75PTPIJ.js");
    if (t3(r)) return a2(r, e);
  }
...
//# sourceMappingURL=chunk-A3YBSIO5.js.map
