import {
  e as e3
} from "./chunk-ZADSSHHN.js";
import {
  R,
  q
} from "./chunk-YVYV6S3Y.js";
import {
  $,
  B as B2,
  D as D2,
  ...
  y as y2,
  z
} from "./chunk-EFLFCM7P.js";
import {
  d as d4
} from "./chunk-VB5BKOZF.js";
import {
  t as t3
} from "./chunk-K252WVKV.js";
import {
  e as e4
...
import {
  ...
  s as s5,
  v as v2
} from "./chunk-EKDGALFD.js";
import {
  t as t4
} from "./chunk-GAMVI7F7.js";
import {
  o as o2
} from "./chunk-26IG3CBM.js";
import {
  a as a2,
  n as n4
...
function w3(n15, e6) {
  const r4 = k(e6), o4 = n15.replaceAll(/[\u00B0\u00BA]/g, "^").replaceAll("′", "'").replaceAll("″", '"'), i6 = [];
  return d.dmsToGeog(r4, 1, [o4], i6) ? new _(i6[0][0], i6[0][1], e6 || f2.WGS84) : null;
}
function g3(n15) {
  var _a, _b;
  return n15 && _4() ? m3(n15) ?? ((_a = w3(`0° 0' 0" N | ${n15}`)) == null ? void 0 : _a.longitude) ?? ((_b = w3(`0 N | ${n15}`)) == null ? void 0 : _b.longitude) ?? null : null;
}
function m4(n15) {
  var _a, _b;
  return n15 && _4() ? m3(n15) ?? ((_a = w3(`${n15} | 0° 0' 0" E`)) == null ? void 0 : _a.latitude) ?? ((_b = w3(`${n15} | 0 E`)) == null ? void 0 : _b.latitude) ?? null : null;
}
function T3(n15, e6, t6) {
  const r4 = [], o4 = A2(t6);
  if (-1 === o4) return console.warn(`invalid conversionMode: ${t6}`), null;
  const i6 = k(e6);
  return M.mgrsToGeogExtended(i6, 1, [n15], o4, r4) ? new _(r4[0][0], r4[0][1], e6 || f2.WGS84) : null;
}
function P3(n15, e6) {
  const t6 = [];
  !e6 && /\(.+27/.test(n15) && (e6 = f2.GCS_NAD_1927);
  const r4 = k(e6);
  return A.usngToGeog(r4, 1, [n15], t6) ? new _(t6[0][0], t6[0][1], e6 || f2.WGS84) : null;
}
function G(n15, e6, t6) {
  const r4 = [], o4 = D3(t6);
  if (-1 === o4) return console.warn(`invalid conversionMode: ${t6}`), null;
  const i6 = k(e6);
  return D.utmToGeog(i6, 1, [n15], o4, r4) ? new _(r4[0][0], r4[0][1], e6 || f2.WGS84) : null;
}
function p2(n15, e6, r4 = 0) {
  const o4 = [[n15.x, n15.y]], i6 = [], l4 = k(n15.spatialReference);
  let u2 = 0;
  switch (e6) {
    case "dd":
      u2 = d.geogToDd(l4, 1, o4, r4, i6);
      break;
    case "ddm":
      u2 = d.geogToDdm(l4, 1, o4, r4, i6);
      break;
    case "dms":
      u2 = d.geogToDms(l4, 1, o4, r4, i6);
      break;
    default:
      return console.warn(`invalid format: ${e6}`), null;
  }
  return u2 ? i6[0] : null;
}
function M3(n15, e6, t6 = 0, r4 = false) {
  const o4 = [[n15.x, n15.y]], i6 = [], l4 = k(n15.spatialReference);
  let u2 = A2(e6);
  if (-1 === u2) return console.warn(`invalid conversionMode: ${e6}`), null;
  r4 && (u2 |= M.PE_MGRS_ADD_SPACES);
  return M.geogToMgrsExtended(l4, 1, o4, t6, false, u2, i6) ? i6[0] : null;
}
function v3(n15, e6 = 0, t6 = false) {
  const r4 = [[n15.x, n15.y]], o4 = [], i6 = k(n15.spatialReference);
  return A.geogToUsng(i6, 1, r4, e6, false, t6, o4) ? o4[0] : null;
}
function R2(n15, e6, t6 = false) {
  const r4 = [[n15.x, n15.y]], o4 = [], i6 = k(n15.spatialReference);
  let l4 = D3(e6);
  if (-1 === l4) return console.warn(`invalid conversionMode: ${e6}`), null;
  t6 && (l4 |= D.PE_UTM_OPTS_ADD_SPACES);
  return D.geogToUtm(i6, 1, r4, l4, o4) ? o4[0] : null;
}
function k(e6) {
...
var e5 = "esri-tooltip";
var t5 = `${e5}-content`;
var n5 = `${e5}-content--input`;
var _5 = `${e5}-content__header`;
var a3 = `${e5}-content__header__spacer`;
var o3 = `${e5}-content__header__actions`;
var s6 = `${e5}-draw-header-actions`;
var c6 = `${e5}-table`;
var $2 = `${e5}-help-message`;
var r2 = `${e5}-help-message__text`;
var h4 = `${e5}-help-message__icon`;

// node_modules/@arcgis/core/views/interactive/tooltip/components/TooltipField.js
var p3 = `${e5}-field`;
var d7 = { base: p3, inputMode: `${p3}--input`, title: `${p3}__title`, value: `${p3}__value` };
...
var p4 = { base: `${e5}-value-by-value` };
var a5 = class extends B {
  constructor() {
    super(...arguments), this.divider = "×";
  }
  render() {
    return n("div", { class: p4.base }, n("span", null, this.left), n("span", null, this.divider), n("span", null, this.right));
  }
};
...
function d8(r4, e6, n15, u2 = 2, i6 = "abbr") {
  return p(r4, s5(e6, n15).value, n15, u2, i6);
}
function M4(r4, e6, a6, n15 = 2, u2 = "abbr") {
  return D2(r4, s5(e6, a6).value, a6, n15, u2);
}
function w4(r4, t6, e6 = 2, a6 = "abbr") {
  return x(r4, t6.value, t6.unit, e6, a6);
}
function I(r4, t6, e6 = 2, a6 = "abbr") {
  return F(r4, t6.value, t6.unit, e6, a6);
}
function V(r4, t6, e6 = 2, a6 = "abbr") {
  return y2(r4, t6.value, t6.unit, e6, a6);
}
function R3(r4, t6, e6 = 2, a6 = "abbr") {
  return d5(r4, t6.value, t6.unit, e6, a6);
}
function y3(r4, t6, e6 = 2, a6 = "abbr") {
  return B2(r4, t6.value, t6.unit, e6, a6);
}
function D4(r4, t6, e6 = 2, a6 = "abbr") {
  return h3(r4, t6.value, t6.unit, e6, a6);
}
function A3(r4, t6, e6 = 2, a6 = "abbr") {
  return M2(r4, t6.value, t6.unit, e6, a6);
}
function T4(r4, t6, e6 = 2, a6 = "abbr") {
...
function q2(r4, t6, e6 = 2, a6 = "abbr") {
  return w2(r4, t6.value, t6.unit, e6, a6);
}
function F2(t6, a6, n15, u2 = a2, i6 = true) {
  return z(t6.value, t6.unit, t6.rotationType, a6, n15, u2, i6);
}
function k2(r4, t6, e6, a6, n15 = "abbr") {
  switch (a6 = a6 ?? 2, e6) {
    case "imperial":
      return D4(r4, t6, a6, n15);
    case "metric":
      return w4(r4, t6, a6, n15);
    default:
      return d8(r4, t6, e6, a6, n15);
  }
}
function z2(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return A3(r4, t6, a6, n15);
    case "metric":
      return I(r4, t6, a6, n15);
    default:
      return M4(r4, t6, e6, a6, n15);
  }
}
function B3(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return T4(r4, t6, a6, n15);
    case "metric":
      return V(r4, t6, a6, n15);
    default:
      return d8(r4, t6, e6, a6, n15);
  }
}
function E2(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return U4(r4, t6, a6, n15);
    case "metric":
      return R3(r4, t6, a6, n15);
    default:
      return M4(r4, t6, e6, a6, n15);
  }
}
function G2(r4, t6, e6, a6 = 2, n15 = "abbr") {
  switch (e6) {
    case "imperial":
      return q2(r4, t6, a6, n15);
    case "metric":
      return y3(r4, t6, a6, n15);
    default:
      return d8(r4, t6, e6, a6, n15);
  }
}
...
var y4 = 6;
function D5(t6, l4) {
  return { angleRelative: x2, direction: j2, directionRelative: R4, directionRelativeBilateral: $3, latitudeDecimalDegrees: L2, longitudeDecimalDegrees: F3, area: (n15, e6) => G2(t6, n15, e6 ?? l4.area), length: (n15, e6, i6) => k2(t6, n15, e6 ?? l4.length, i6), lengthRelative: (n15, e6) => z2(t6, n15, e6 ?? l4.length), totalLength: (n15, e6) => k2(t6, n15, e6 ?? l4.length), verticalLength: (n15, r4) => B3(t6, n15, r4 ?? l4.verticalLength), verticalLengthRelative: (e6, r4) => E2(t6, e6, r4 ?? l4.verticalLength), percentage: z3, scalar: Z2, scale: T5 };
}
function x2(t6) {
  return c(t6, { signDisplay: "exceptZero", ...b2(v4) });
}
function j2(t6) {
  return F2(t6, t6.rotationType, v4);
}
function R4(t6) {
  const n15 = R(t6);
  return c(n15, { style: "unit", unitDisplay: "narrow", unit: "degree", signDisplay: n15 > 0 ? "never" : "exceptZero", ...b2(v4) });
}
function $3(t6) {
  return F2(t6, t6.rotationType, v4);
}
...
function U5(t6, n15) {
  ...
  return F2(s5(t6, "degrees"), r4, y4, n15, e6);
}
function q3(t6, n15) {
  const e6 = false, r4 = n15.normalize(s5(t6, "degrees").value, void 0, e6);
  return Z2(i3(r4), y4);
}
function z3(t6) {
...
function Z2(t6, n15) {
  return c(t6.value, b2(n15));
}
function b2(t6) {
  return { minimumFractionDigits: t6, maximumFractionDigits: t6 };
}
function B4({ createQuantity: t6, sanitize: n15 }) {
  return (e6, r4) => {
    if (null == e6) return null;
    n15 && (e6 = n15(e6));
    const i6 = m3(e6);
    return null == i6 ? null : t6(i6, r4);
  };
}
function C2(t6) {
...
var I2 = " ";
var M5 = [];
for (const P6 of [",", "\\|", "\\s+"]) for (const t6 of ["\\.", ",", ""]) for (const n15 of ["", ",", "\\.", I2, "\\s+"]) P6 !== t6 && P6 !== n15 && t6 !== n15 && M5.push({ separator: P6, decimal: t6, thousands: n15, pattern: E3({ decimal: t6, thousands: n15, separator: P6 }) });
function Q(t6) {
  for (const { decimal: n15, thousands: e6, pattern: r4 } of M5) {
    r4.lastIndex = 0;
    const i6 = t6.match(r4);
    if (!i6) continue;
    const o4 = m3(k3(i6[1], n15, e6)), l4 = m3(k3(i6[2], n15, e6));
...
function k3(t6, n15, e6) {
  ...
  return "" !== e6 && (r4 = r4.replaceAll(e6, "")), "" !== n15 && (r4 = r4.replaceAll(n15, ".")), r4;
}
function G3(t6) {
  if (!t6 || null != m3(t6) || !_4()) return null;
  const n15 = w3(t6), e6 = K2(n15 == null ? void 0 : n15.latitude), r4 = K2(n15 == null ? void 0 : n15.longitude);
...
var S2 = class extends B {
  constructor() {
    super(...arguments), this._focusAbortController = new AbortController(), this._transitionInfo = null, this._mode = "feedback", this._getFormatters = t4(D5), this._onHeaderPointerDown = (t6) => {
      var _a;
      const e6 = t6.target;
      ...
      const o4 = this._getFocusableElements(), i6 = o4.length, s15 = o4.indexOf(t6);
      if (-1 === s15) return void this.exitInputMode();
      const n15 = ((s15 + ("commit-and-next" === e6 ? 1 : -1)) % i6 + i6) % i6;
      L3(o4.at(n15));
    }, this._onKeyDown = (t6) => {
      switch (t6.code) {
        case d6.next:
  ...
  get _inputUnitInfos() {
    const t6 = this._messagesUnits, e6 = (e7) => ({ unit: e7, abbreviation: g2(t6, e7, "abbr") }), { inputUnits: o4 } = this.info.sketchOptions.values, i6 = e3(this.tooltip.view), s15 = o4.length ?? i6, n15 = o4.verticalLength ?? i6, r4 = o4.area ?? i6;
    return { length: e6(J(s15)), verticalLength: e6(T2(n15)), area: e6(K(r4)), angle: e6("degrees") };
  }
  get _formatters() {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-WW2DH5PE.js"), icon: () => import("./calcite-icon-JEA5ABMK.js"), input: () => import("./calcite-input-KGUATIKV.js") });
  }
  ...
  async exitInputMode({ focusOnView: t6 = true } = {}) {
    ...
    try {
      ...
      o4.clearInputValues();
      const i6 = t6 ? (_a = e6 == null ? void 0 : e6.closest(".esri-view")) == null ? void 0 : _a.querySelector(".esri-view-surface") : null;
  ...
  get _renderedHelpMessage() {
    ...
    return n("div", { class: $2, key: "help-message" }, i6 ? n("calcite-icon", { class: h4, icon: i6, scale: "s" }) : null, n("div", { class: r2 }, o4));
  }
  ...
  async _transitionTo(t6, o4) {
    ...
    if (!((_c = this.domNode) == null ? void 0 : _c.firstChild) || !document.startViewTransition || o2()) return void await i6();
    this.autoRenderingEnabled = false;
    const s15 = this._transitionInfo = { transition: document.startViewTransition(async () => {
      this.destroyed || s15 !== this._transitionInfo || (this.autoRenderingEnabled = true, await i6());
    }), mode: t6 };
    try {
...
var n6 = class extends S2 {
  _renderContent() {
    const { area: t6, radius: o4, xSize: s15, ySize: n15, visibleElements: a6 } = this.info, p7 = this._messagesTooltip.sketch, m6 = this._formatters;
    return n(i, null, a6.radius && null != o4 ? n(a4, { title: p7.radius, value: m6.length(o4) }) : null, a6.size && null != s15 && null != n15 ? n(a4, { title: p7.size, value: n(a5, { left: m6.length(s15), right: m6.length(n15) }) }) : null, a6.area ? n(a4, { title: p7.area, value: m6.area(t6) }) : null);
  }
};
n6 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentDrawCircle")], n6);

// node_modules/@arcgis/core/views/interactive/tooltip/components/TooltipEditableField.js
var p5 = `${e5}-editable-field`;
var d9 = { base: p5, inputMode: `${p5}--input`, feedbackMode: `${p5}--feedback`, readOnly: `${p5}--read-only`, locked: `${p5}--locked`, title: `${p5}__title`, value: `${p5}__value`, valueContent: `${p5}__value__content`, valueContentReadOnly: `${p5}__value__content--read-only`, lockIcon: `${p5}__lock-icon`, input: `${p5}__input`, inputWrapper: `${p5}__input-wrapper`, inputMessage: `${p5}__input-message`, inputSuffix: `${p5}__input-suffix`, button: `${p5}__button` };
...
var _6 = class extends B {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-WW2DH5PE.js"), icon: () => import("./calcite-icon-JEA5ABMK.js"), input: () => import("./calcite-input-KGUATIKV.js"), "input-message": () => import("./calcite-input-message-4EKT5TCP.js") });
  }
  render() {
    const { field: t6, mode: e6 } = this, i6 = "input" === e6, { locked: o4, readOnly: n15 } = t6;
    return n("div", { class: this.classes({ [d9.base]: true, [d9.feedbackMode]: "feedback" === e6, [d9.inputMode]: "input" === e6, [d9.locked]: o4, [d9.readOnly]: n15 }) }, n("div", { class: d9.title, key: "title" }, this._title), n("div", { class: d9.value, key: "value", onkeydown: this._onKeyDown }, i6 ? this._renderValueInputMode() : this._renderValueFeedbackMode()));
  }
  get _formattedValue() {
  ...
  get _renderedLockButton() {
    ...
    const o4 = this._messages, n15 = e6 ? o4.unlockConstraint : o4.lockConstraint;
    return n("calcite-button", { afterCreate: this._onLockAfterCreate, afterRemoved: this._onLockAfterRemoved, alignment: "center", appearance: "transparent", class: d9.button, "data-testid": `tooltip-field-${t6}-lock`, iconStart: e6 ? h5.lock : h5.unlock, key: "lock-button", kind: "neutral", label: n15, onclick: this._onLockClick, scale: "s", tabIndex: -1, title: n15 });
  }
};
...
function i4(i6) {
  const l4 = i6.fields.filter((t6) => true === (t6 == null ? void 0 : t6.visible));
  return 0 === l4.length ? null : n(i, null, l4.map((e6) => n(_6, { context: i6.context, field: e6, key: e6.id, mode: i6.mode })));
}

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentDrawMesh.js
var s7 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: i6 } = this, { visibleElements: s15 } = t6;
    return n(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0, s15.orientation ? t6.orientation : void 0, s15.scale ? t6.scale : void 0], mode: i6 });
  }
};
...
var s8 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: r4 } = this, { elevation: s15, visibleElements: n15 } = t6;
    return n(i4, { context: o4, fields: [n15.coordinates ? t6.effectiveX : void 0, n15.coordinates ? t6.effectiveY : void 0, n15.elevation ? s15 : void 0], mode: r4 });
  }
};
...
var p6 = class extends B {
  ...
  loadDependencies() {
    return c2({ button: () => import("./calcite-button-WW2DH5PE.js"), dropdown: () => import("./calcite-dropdown-CXX4FCOZ.js"), "dropdown-item": () => import("./calcite-dropdown-item-NINTBKMK.js"), "dropdown-group": () => import("./calcite-dropdown-group-DNKGOSGE.js") });
  }
...
function l3(t6) {
  var _a, _b, _c, _d;
  const { directionMode: e6 } = t6.sketchOptions.values, o4 = (_a = t6.messages) == null ? void 0 : _a.sketch, i6 = (_b = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _b.title, r4 = "absolute", c7 = "relative";
  ...
  } }, n("calcite-button", { alignment: "end", appearance: "transparent", iconStart: e4[e6], kind: "neutral", label: i6, scale: "s", slot: "trigger", title: i6 }), n("calcite-dropdown-group", { selectionMode: "single" }, n("calcite-dropdown-item", { "data-mode": c7, "data-testid": "tooltip-direction-mode-relative", iconStart: e4.relative, key: "relative", selected: e6 === c7 }, (_c = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _c.relative), n("calcite-dropdown-item", { "data-mode": r4, "data-testid": "tooltip-direction-mode-absolute", iconStart: e4.absolute, key: "absolute", selected: e6 === r4 }, (_d = o4 == null ? void 0 : o4.directionModeSelect) == null ? void 0 : _d.absolute)));
}
__decorate([e2("esri/views/interactive/tooltip/t9n/Tooltip"), m2()], p6.prototype, "messages", void 0), __decorate([m2()], p6.prototype, "sketchOptions", void 0), __decorate([m2()], p6.prototype, "visibleElements", void 0), p6 = __decorate([a("esri.views.interactive.tooltip.components.DrawHeaderActions")], p6);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentDrawPolygon.js
var n7 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: e6 } = this, { xyMode: r4, visibleElements: n15 } = t6;
    return n(i4, { context: o4, fields: [..."direction-distance" === r4 ? [n15.direction ? t6.direction : void 0, n15.distance ? t6.distance : void 0] : [n15.coordinates ? t6.effectiveX : void 0, n15.coordinates ? t6.effectiveY : void 0], n15.elevation ? t6.elevation : void 0, n15.area ? t6.area : void 0], mode: e6 });
  }
  _renderActions() {
    const { xyMode: o4, sketchOptions: t6 } = this.info;
    return n(p6, { sketchOptions: t6, visibleElements: { direction: "direction-distance" === o4 } });
  }
};
n7 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentDrawPolygon")], n7);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentDrawPolyline.js
var n8 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: e6 } = this, { xyMode: r4, visibleElements: n15 } = t6;
    return n(i4, { context: o4, fields: [..."direction-distance" === r4 ? [n15.direction ? t6.direction : void 0, n15.distance ? t6.distance : void 0] : [n15.coordinates ? t6.effectiveX : void 0, n15.coordinates ? t6.effectiveY : void 0], n15.elevation ? t6.elevation : void 0, n15.totalLength ? t6.totalLength : void 0], mode: e6 });
  }
  _renderActions() {
    const { xyMode: o4, sketchOptions: t6 } = this.info;
    return n(p6, { sketchOptions: t6, visibleElements: { direction: "direction-distance" === o4 } });
...
n8 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentDrawPolyline")], n8);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentDrawRectangle.js
var n9 = class extends S2 {
  _renderContent() {
    const { area: t6, xSize: o4, ySize: s15, visibleElements: n15 } = this.info, p7 = this._messagesTooltip.sketch, a6 = this._formatters;
    return n(i, null, n15.size && null != o4 && null != s15 ? n(a4, { title: p7.size, value: n(a5, { left: a6.length(o4), right: a6.length(s15) }) }) : null, n15.area ? n(a4, { title: p7.area, value: a6.area(t6) }) : null);
  }
};
n9 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentDrawRectangle")], n9);
...
n10 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentExtentRotate")], n10);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentExtentScale.js
var n11 = class extends S2 {
  _renderContent() {
    const t6 = this.info, { visibleElements: e6 } = t6, r4 = this._messagesTooltip.sketch, n15 = this._formatters;
    return n(i, null, e6.size ? n(a4, { title: r4.size, value: n(a5, { left: n15.length(t6.xSize), right: n15.length(t6.ySize) }) }) : null, e6.scale ? n(a4, { title: r4.scale, value: n(a5, { left: n15.scale(t6.xScale), right: n15.scale(t6.yScale) }) }) : null);
  }
};
n11 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentExtentScale")], n11);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentMovePoint.js
var s10 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: i6 } = this, { visibleElements: s15 } = t6;
    return n(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0], mode: i6 });
  }
};
...
var i5 = class extends S2 {
  _renderContent() {
    const { fieldContext: t6, info: o4, mode: r4 } = this, { visibleElements: i6 } = o4;
    return n(i4, { context: t6, fields: [i6.distance ? o4.distance : void 0, i6.area ? o4.area : void 0, i6.totalLength ? o4.totalLength : void 0], mode: r4 });
  }
};
...
var s13 = class extends S2 {
  _renderContent() {
    const { fieldContext: o4, info: t6, mode: i6 } = this, { visibleElements: s15 } = t6;
    return n(i4, { context: o4, fields: [s15.coordinates ? t6.effectiveX : void 0, s15.coordinates ? t6.effectiveY : void 0, s15.elevation ? t6.elevation : void 0, s15.orientation ? t6.orientation : void 0, s15.size ? t6.size : void 0], mode: i6 });
  }
};
...
var n12 = class extends S2 {
  _renderContent() {
    const { info: t6 } = this, { visibleElements: o4 } = t6, r4 = this._messagesTooltip.sketch, n15 = this._formatters;
    return n(i, null, o4.distance ? n(a4, { title: r4.distance, value: n15.length(t6.distance) }) : null);
  }
};
n12 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentTranslate")], n12);

// node_modules/@arcgis/core/views/interactive/tooltip/content/TooltipContentTranslateVertex.js
var s14 = class extends S2 {
  _renderContent() {
    const { distance: t6, elevation: e6, area: l4, totalLength: s15, visibleElements: a6 } = this.info, n15 = this._messagesTooltip.sketch, p7 = this._formatters;
    return n(i, null, a6.distance ? n(a4, { title: n15.distance, value: p7.length(t6) }) : null, a6.elevation && null != (e6 == null ? void 0 : e6.actual) ? n(a4, { title: n15.elevation, value: p7.verticalLength(e6.actual) }) : null, a6.area && null != l4 ? n(a4, { title: n15.area, value: p7.area(l4) }) : null, a6.totalLength && null != s15 ? n(a4, { title: n15.totalLength, value: p7.length(s15) }) : null);
  }
};
...
n13 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentTranslateXY")], n13);
...
n14 = __decorate([a("esri.views.interactive.tooltip.content.TooltipContentTranslateZ")], n14);
...
function d10(d11, x4) {
  ...
  switch (x4.type) {
    ...
    case "draw-circle":
      return new n6({ tooltip: d11, info: x4, container: h6 });
    case "elevation":
...
var v5 = { base: `${e5}`, ltr: `${e5}--ltr`, rtl: `${e5}--rtl`, debug: `${e5}--debug` };
var _7 = 20;
var C3 = 16;
var b3 = "bottom-end";
var P4 = class extends l {
  ...
  initialize() {
    ...
    }, h), l2(() => ({ outerContainer: this.outerContainer, placement: this.effectivePlacement, effectiveOffset: this._effectiveOffset, rtl: this._rtl, debug: this.debug }), ({ outerContainer: t7, placement: e6, effectiveOffset: o4, rtl: n15, debug: i6 }) => {
      const { classList: s15 } = t7;
      s15.add(v5.base), s15.toggle(v5.rtl, n15), s15.toggle(v5.ltr, !n15), s15.toggle(v5.debug, i6), this.outerContainer.style.setProperty("--offset", `${o4}px`), s3(t7), x3(t7, e6);
  ...
  async enterInputMode(t6) {
    var _a;
    const e6 = this.position ?? this._lastPosition ?? this._screenPoint, o4 = this.position = c4(e6), { effectivePlacement: n15 } = this;
    ...
    await this._updatingHandles.addPromise((_a = this.content) == null ? void 0 : _a.enterInputMode(t6, i6));
  }
  ...
  onDrag(t6, e6) {
    const o4 = t6 - this._prevXY[0], n15 = e6 - this._prevXY[1];
    this._prevXY = [t6, e6];
    ...
    if (i6) {
      ...
      this.position = i2(i6.x + o4, i6.y + n15);
    }
  }
  onDragEnd() {
    this._prevXY = [0, 0];
...
function j3(t6, e6, o4, n15) {
  if (!t6 || !n15.container) return e6;
  const i6 = t6.getBoundingClientRect(), { left: s15, top: r4 } = n15.container.getBoundingClientRect();
  let { x: l4, y: a6 } = e6;
  const c7 = i6.left - s15 - o4;
  c7 < 0 && (l4 -= c7);
  const u2 = i6.right - s15 + o4 - n15.width;
  u2 > 0 && (l4 -= u2);
  const d11 = i6.top - r4 - o4;
  d11 < 0 && (a6 -= d11);
  const h6 = i6.bottom - r4 + o4 - n15.height;
  return h6 > 0 && (a6 -= h6), i2(l4, a6);
}
__decorate([m2({ nonNullable: true })], P4.prototype, "view", void 0), __decorate([m2()], P4.prototype, "info", void 0), __decorate([m2()], P4.prototype, "options", void 0), __decorate([m2()], P4.prototype, "position", void 0), __decorate([m2()], P4.prototype, "content", void 0), __decorate([m2({ readOnly: true })], P4.prototype, "mode", null), __decorate([m2()], P4.prototype, "_focused", void 0), __decorate([m2({ readOnly: true })], P4.prototype, "focused", null), __decorate([m2({ readOnly: true })], P4.prototype, "outerContainer", void 0), __decorate([m2({ readOnly: true })], P4.prototype, "contentContainer", null), __decorate([m2({ readOnly: true })], P4.prototype, "effectivePlacement", null), __decorate([m2()], P4.prototype, "debug", void 0), __decorate([m2()], P4.prototype, "updating", null), __decorate([m2()], P4.prototype, "_lastPosition", void 0), __decorate([m2()], P4.prototype, "_screenPoint", null), __decorate([m2()], P4.prototype, "_rtl", void 0), __decorate([m2()], P4.prototype, "_effectiveOffset", null), __decorate([m2()], P4.prototype, "_outerContainerStyle", null), P4 = __decorate([a("esri.views.interactive.Tooltip")], P4);
var O3 = ["top", "bottom", "leading", "trailing"].flatMap((t6) => [w6(`${t6}-start`), w6(t6), w6(`${t6}-end`)]);
function w6(t6) {
  return `${v5.base}--${t6}`;
}
function x3({ classList: t6 }, e6) {
  O3.forEach((e7) => t6.remove(e7)), t6.add(w6(e6));
}
var $4 = P4;
...
function R5(t6) {
  const o4 = new $4(t6());
  return o4.addHandles(l2(() => t6(), ({ view: t7, options: e6, info: n15 }) => {
    o4.view = t7, void 0 !== e6 && (o4.options = e6), void 0 !== n15 && (o4.info = n15);
  })), o4;
}
function V2(t6, o4) {
  const e6 = t3(o4.vertexSpace), { scale: n15, orientation: l4 } = t6, { transform: a6 } = o4, s15 = T6(a6);
  e6 && null != s15 ? (l4.actual = c5(s15, "degrees", "arithmetic"), l4.visible = true) : (l4.actual = null, l4.visible = false), e6 ? (n15.actual = i3(G4(a6)), n15.visible = true) : (n15.actual = null, n15.visible = false);
}
function z4(t6, o4, e6) {
  if (!o4 || !t3(o4.vertexSpace)) return;
  const n15 = o4.transform ?? (o4.transform = new d4());
  D6(t6, n15, e6), P5(t6, n15, e6);
}
function D6(t6, o4, e6) {
  const r4 = q(t6.orientation.actual), i6 = q4(o4.rotationAxis);
  if (null == r4 || null == i6) return;
  const l4 = r4 - 90, a6 = o4.rotationAngle, s15 = l4 * i6, u2 = s15 - a6;
...
function P5(t6, o4, e6) {
  var _a;
  const n15 = (_a = t6.scale.actual) == null ? void 0 : _a.value, r4 = G4(o4);
  if (null == n15 || n15 === r4) return;
  const { scale: i6 } = o4;
  let l4;
  if (0 === r4) l4 = t2(_2);
  else {
  ...
  e6 == null ? void 0 : e6.onScaleStart(i6[0], i6[1], i6[2]), o4.scale = l4, e6 == null ? void 0 : e6.onScale(l4[0], l4[1], l4[2]), e6 == null ? void 0 : e6.onScaleStop(l4[0], l4[1], l4[2]);
}
function F4(t6, o4) {
  const { x: e6, y: r4, z: i6 } = o4, { x: l4, y: a6, z: s15 } = E5(t6, o4.spatialReference);
  return { dx: null == l4 || P2(l4, e6) ? 0 : l4 - e6, dy: null == a6 || P2(a6, r4) ? 0 : a6 - r4, dz: null == s15 || null == i6 || P2(s15, i6) ? 0 : s15 - i6 };
}
function E5(t6, o4) {
  var _a, _b;
  let e6, n15;
  t6.geographic ? (e6 = R(t6.longitude.actual), n15 = R(t6.latitude.actual), C(o4) && (null != e6 && null != n15 ? [e6, n15] = d2(e6, n15, I3) : null != e6 ? e6 = d2(e6, 0, I3)[0] : null != n15 && (n15 = d2(0, n15, I3)[1]))) : (e6 = (_a = t6.x.actual) == null ? void 0 : _a.value, n15 = (_b = t6.y.actual) == null ? void 0 : _b.value);
  const r4 = t6.elevation.actual, i6 = fe(o4);
  return { x: e6, y: n15, z: null != i6 && null != r4 ? v2(r4, i6) : void 0 };
}
var I3 = [0, 0];
function T6(t6) {
  const o4 = 90;
...
function O4(t6) {
  ...
  if (!o4) return false;
  const { inputEnabled: e6, visibleElements: n15 } = o4.tooltips;
  return e6 && true === t6.editableFields.some(({ name: t7 }) => "x" === t7 || "y" === t7 ? n15.coordinates : n15[t7]);
}
function C4(n15, r4) {
  let i6 = null;
  return t([n15.on("paste", (o4) => {
    i6 == null ? void 0 : i6.abort(), i6 = d3(async () => {
      _4() || await E(), J4(o4, n15.info, r4);
    });
  }), d3(() => E()), e(() => i6 == null ? void 0 : i6.abort())]);
}
function J4(t6, o4, e6) {
  var _a;
  if (!o4 || !("geographic" in o4)) return;
  const n15 = (_a = t6.clipboardData) == null ? void 0 : _a.getData("text");
  if (!n15) return;
  const r4 = (o5) => {
...
//# sourceMappingURL=chunk-VIE73CY3.js.map
