...
import {
  ...
  m as m5,
  t2 as t3
} from "./chunk-WU7W2U7B.js";
import {
  p as p2,
  s as s5
} from "./chunk-X4P6RGHW.js";
...
import {
  l as l6
} from "./chunk-L5XEHAL5.js";
import {
  j as j4
} from "./chunk-AEI7WL66.js";
...
async function t5(e3) {
  const { BlobReader: t6, ZipReader: r3, BlobWriter: n8 } = await import("./zipjs-wrapper-3MAPSWJK.js"), a8 = [], i6 = new r3(new t6(e3));
...
var Te = class extends a7(F(_3(l3(b2(j2(t(l(s4(o3(l2(b3))))))))))) {
  ...
  async applyEdits(e3, t6) {
    const { applyEdits: r3 } = await import("./editingSupport-G4JSAY2L.js");
    let i6 = t6;
    await this.load();
  ...
  async convertMesh(e3, t6) {
    t6 ?? (t6 = {}), null != t6.location && m2(i.getLogger(this), "The 'location' option of convertMesh() has been deprecated in favour of 'origin'.", { version: "4.34", replacement: "origin", warnOnce: true });
    const r3 = (e4) => {
    ...
    const n8 = this.spatialReference, p6 = t6.origin ?? t6.location, d5 = await H2(p6 ?? t6.defaultOrigin ?? new _({ x: 0, y: 0, z: 0, spatialReference: n8 }), n8, t6), y3 = d5.spatialReference.isGeographic ? "local" : "georeferenced", { default: u5 } = await import("./Mesh-4XJ4LBTV.js");
    s2(t6);
...
//# sourceMappingURL=SceneLayer-Y7FMBFXE.js.map
