...
var P2 = class extends b {
  ...
  _updatePointSymbology(e4) {
    ...
    r2 && "getSymbolAsync" in r2 ? r2.getSymbolAsync(e4).then(async (i5) => {
      ...
      n4 && (G || (G = (await import("./visualVariableUtils-6A2UDY34.js")).getSize), l4 = G(n4, e4, { view: o4.type, scale: o4.scale, shape: "simple-marker" === i5.type ? i5.style : null })), l4 || (l4 = "width" in i5 && "height" in i5 && null != i5.width && null != i5.height ? Math.max(i5.width, i5.height) : "size" in i5 ? i5.size : 16), (s4 == null ? void 0 : s4.includes(e4)) && (this._setGraphicSymbol(e4, new u3({ style: "square", size: l4, color: new u2([255, 255, 255, 1 / 255]), xoffset: "xoffset" in i5 ? i5.xoffset : 0, yoffset: "yoffset" in i5 ? i5.yoffset : 0 })), a5(e4));
    }) : a5(e4);
  }
  get _updateContext() {
...
//# sourceMappingURL=chunk-6LPTJP7S.js.map
