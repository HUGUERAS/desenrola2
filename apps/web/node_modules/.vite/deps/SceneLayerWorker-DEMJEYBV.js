...
async function d2(e) {
  ...
  let p3;
  const [{ projectBuffer: h3 }, { initializeProjection: b2 }] = await Promise.all([import("./projectBuffer-6TDROIKZ.js"), import("./projectionUtils-R2W6BRQX.js")]);
  await b2(l, u2);
  const d3 = [0, 0, 0];
  ...
  if ("georeferenced" === c2.type && null == c2.origin) {
    ...
    const e2 = "georeferenced" === c2.type ? i.fromJSON(c2) : i2.fromJSON(c2), { projectMeshVertexPositions: r2 } = await import("./projectMeshVertexPositions-IVIQNQPN.js"), t = r2({ vertexAttributes: { position: f3 }, transform: m2 ? { localMatrix: m2 } : void 0, vertexSpace: e2, spatialReference: l }, u2);
...
//# sourceMappingURL=SceneLayerWorker-DEMJEYBV.js.map
