import {
  n as n3,
  p as p2
} from "./chunk-7M6QHWNX.js";
import {
  p as p4
} from "./chunk-NVYIDU2L.js";
import {
  e as e2,
  i,
  p as p3,
  p2 as p5
} from "./chunk-M5HEBENN.js";
import {
  l
...
async function F(e3, r) {
  ...
  return await t2.load(), null === J && (J = await import("./knowledgeGraphService-NH2VND3J.js")), await J.fetchKnowledgeGraph(t2.url);
}
...
function K2(e3) {
  "async" === e3.mode && (e3.functions.knowledgegraphbyportalitem = function(t2, i2) {
    ...
    return e3.standardFunctionAsync(r, a, async (e4, l2, c3) => {
      ...
      null === J && (J = await import("./knowledgeGraphService-NH2VND3J.js"));
      let m = null;
      const d = z(c3[2], null);
...
//# sourceMappingURL=knowledgegraph-PAP5A7LQ.js.map
