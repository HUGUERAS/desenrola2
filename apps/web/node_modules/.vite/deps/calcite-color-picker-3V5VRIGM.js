import {
  ...
  repeat
} from "./chunk-SKL35GGD.js";
import "./chunk-AD4ETPQ5.js";
import {
  useCancelable
} from "./chunk-H6FL27ZY.js";
import "./chunk-DD4TMQGV.js";
import {
  throttle
} from "./chunk-WKT3PGC4.js";
import {
  syncHiddenFormInput
} from "./chunk-J7C3YKEW.js";
import {
  Validation
} from "./chunk-VACBTRHD.js";
import "./chunk-GRV5RXTW.js";
import {
  InternalLabel
} from "./chunk-6ADSO7K5.js";
import {
  connectLabel,
  disconnectLabel,
  getLabelText
} from "./chunk-WWD5CKLW.js";
import {
  isActivationKey
} from "./chunk-MPGW2LBV.js";
import "./chunk-J4ROKSOK.js";
import {
  keyed
} from "./chunk-3FGQ5TAU.js";
import {
  HiddenFormInputSlot,
  connectForm,
  disconnectForm,
  ...
  submitForm
} from "./chunk-TR3LRDEN.js";
import {
  InteractiveContainer,
  updateHostInteraction
} from "./chunk-B7GJD6QU.js";
import {
  getIconScale,
  useSetFocus
} from "./chunk-NOEHYDVP.js";
import "./chunk-AIXKX2QK.js";
import "./chunk-P7DS4EQQ.js";
import "./chunk-FX2WWTMM.js";
import {
  createObserver,
  updateRefObserver
} from "./chunk-DRPOV4MX.js";
import {
  ...
  toAriaBoolean
} from "./chunk-JDWO5X4U.js";
import "./chunk-72LLUUBL.js";
import {
  useT9n
} from "./chunk-QLJHF7OJ.js";
import {
  useWatchAttributes
} from "./chunk-QYCU6XWH.js";
import {
  guid
...
var styles3 = css`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}.hex-input{--calcite-input-text-background-color: var(--calcite-color-picker-input-background-color);--calcite-input-text-border-color: var(--calcite-color-picker-input-border-color);--calcite-input-text-text-color: var(--calcite-color-picker-input-text-color);--calcite-input-prefix-background-color: var(--calcite-color-picker-input-prefix-background-color);--calcite-input-prefix-text-color: var(--calcite-color-picker-input-prefix-text-color)}.opacity-input{--calcite-input-number-background-color: var(--calcite-color-picker-input-background-color);--calcite-input-number-border-color: var(--calcite-color-picker-input-border-color);--calcite-input-number-text-color: var(--calcite-color-picker-input-text-color);--calcite-input-suffix-background-color: var(--calcite-color-picker-input-suffix-background-color);--calcite-input-suffix-text-color: var(--calcite-color-picker-input-suffix-text-color)}:host{display:block}.container{display:flex;inline-size:100%;flex-wrap:nowrap;align-items:center}.hex-input{flex-grow:1;text-transform:uppercase}.opacity-input{inline-size:100px;margin-inline-start:-1px}:host([hidden]){display:none}[hidden]{display:none}`;
...
_ColorPickerHexInput.styles = styles3;
...
var styles4 = css`:host{--calcite-internal-color-focus: var( --calcite-color-focus, var(--calcite-ui-focus-color, var(--calcite-color-brand)) )}:host{display:flex;flex-direction:column}:host([bordered]){box-shadow:inset 0 1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1));background-color:var(--calcite-tab-background-color, var(--calcite-color-foreground-1))}:host([bordered]) section{border-color:var(--calcite-tab-border-color, var(--calcite-color-border-1));border-style:solid}section{display:flex;flex-grow:1;overflow:hidden;border-width:1px;border-block-start-style:solid;border-block-start-color:var(--calcite-tab-border-color, var(--calcite-color-border-1))}:host([bordered][position=bottom]){box-shadow:inset 0 1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1)),inset 0 -1px 0 var(--calcite-tab-border-color, var(--calcite-color-border-1))}:host([bordered]:not([position=bottom])) ::slotted(calcite-tab-nav){margin-block-end:-1px}:host([position=bottom]){flex-direction:column-reverse}:host([position=bottom]) section{flex-direction:column-reverse;border-block-start-width:0px;border-block-end-width:1px}:host([bordered][scale=s]) section{padding:.75rem}:host([bordered][scale=m]) section{padding:.5rem}:host([bordered][scale=l]) section{padding:1rem}:host([position=bottom]:not([bordered])) section{border-block-end-style:solid;border-block-end-color:var(--calcite-tab-border-color, var(--calcite-color-border-1))}@media (forced-colors: active){:host([bordered]) section{border-block-start-width:0px;border-block-end-width:1px}:host([position=bottom][bordered]) section{border-block-start-width:1px;border-block-end-width:0px}}:host([hidden]){display:none}[hidden]{display:none}`;
...
var _TabNav = class _TabNav extends LitElement {
  ...
  render() {
    ...
    return html`<div class=${safeClassMap({
      [CSS6.container]: true,
      [CSS6.containerHasStartTabTitleOverflow]: !!this.hasOverflowingStartTabTitle,
      [CSS6.containerHasEndTabTitleOverflow]: !!this.hasOverflowingEndTabTitle,
  ...
  renderScrollButton(overflowDirection) {
    ...
    return keyed(overflowDirection, html`<div class=${safeClassMap({
      [CSS6.scrollButtonContainer]: true,
      [CSS6.scrollBackwardContainerButton]: !isEnd,
      [CSS6.scrollForwardContainerButton]: isEnd
...
var _SwatchGroup = class _SwatchGroup extends LitElement {
  ...
  render() {
    ...
    const { disabled } = this;
    return InteractiveContainer({ disabled, children: html`<div .ariaLabel=${this.label} class=${safeClassMap(CSS7.container)} .role=${role}><slot @slotchange=${this.updateItems} ${ref(this.slotRefEl)}></slot></div>` });
  }
};
...
var _TabTitle = class _TabTitle extends LitElement {
  ...
  render() {
    ...
    const iconStartEl = html`<calcite-icon class=${safeClassMap({ [CSS9.titleIcon]: true, [CSS9.iconStart]: true })} .flipRtl=${this.iconFlipRtl === "start" || this.iconFlipRtl === "both"} .icon=${this.iconStart} .scale=${getIconScale(this.scale)}></calcite-icon>`;
    const iconEndEl = html`<calcite-icon class=${safeClassMap({ [CSS9.titleIcon]: true, [CSS9.iconEnd]: true })} .flipRtl=${this.iconFlipRtl === "end" || this.iconFlipRtl === "both"} .icon=${this.iconEnd} .scale=${getIconScale(this.scale)}></calcite-icon>`;
    ...
    return InteractiveContainer({ disabled: this.disabled, children: html`<div class=${safeClassMap({
      [CSS9.container]: true,
      [CSS9.containerBottom]: this.position === "bottom",
      [CSS9.iconPresent]: !!this.iconStart || !!this.iconEnd,
      [CSS9.scale(this.scale)]: true
    })} .hidden=${closed} ${ref(this.setContainerRef)}><div class=${safeClassMap({ [CSS9.content]: true, [CSS9.contentHasText]: this.hasText })}>${this.iconStart ? iconStartEl : null}<slot></slot>${this.iconEnd ? iconEndEl : null}</div>${this.renderCloseButton()}<div class=${safeClassMap(CSS9.selectedIndicator)}></div></div>` });
  }
  renderCloseButton() {
...
var _Tab = class _Tab extends LitElement {
  ...
  render() {
    ...
    setAttribute(this.el, "id", id);
    return html`<div class=${safeClassMap({ [CSS10.container]: true, [CSS10.scale(this.scale)]: true })} role=tabpanel .tabIndex=${this.selected ? 0 : -1}><section class=${safeClassMap(CSS10.content)}><slot></slot></section></div>`;
  }
};
...
@esri/calcite-components/dist/chunks/core.js:
  (*! All material copyright ESRI, All Rights Reserved, unless otherwise specified.
  See https://github.com/Esri/calcite-design-system/blob/dev/LICENSE.md for details.
  v3.3.3 *)
...
@esri/calcite-components/dist/components/calcite-color-picker/customElement.js:
  ...
  v3.3.3 *)
*/
//# sourceMappingURL=calcite-color-picker-3V5VRIGM.js.map
