...
async function o(o2) {
  var _a;
  const a2 = "portalItem" in o2 ? o2 : { portalItem: o2 }, { fromItem: e } = await import("./portalLayers-S5HHA2NF.js");
  try {
    return await e(a2);
  } catch (p) {
...
var b = class extends n(s3(u)) {
  ...
  static async fromArcGISServerUrl(t) {
    ...
    return (await import("./arcgisLayers-IQ2Y4AHH.js")).fromUrl(e);
  }
...
//# sourceMappingURL=chunk-ZRYPC5OU.js.map
