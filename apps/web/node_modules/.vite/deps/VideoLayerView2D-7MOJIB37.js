import {
  f as f2
} from "./chunk-5PG3UV46.js";
import {
  i as i2
} from "./chunk-EPPOB3UC.js";
import "./chunk-2GCOQTG5.js";
import "./chunk-EQO7O7UM.js";
import {
  O
} from "./chunk-OTTQMXDM.js";
import "./chunk-NDM2VNBI.js";
import "./chunk-FEFBXLLP.js";
import "./chunk-CNKCFWLM.js";
import "./chunk-Q7XX6FGU.js";
import {
  b,
  n as n3
} from "./chunk-XAAJYMMN.js";
import {
  d
} from "./chunk-ZT5GSCZY.js";
import "./chunk-IPPFWVTA.js";
import "./chunk-ISA6GBAU.js";
import {
  e
} from "./chunk-GVZSAQSO.js";
import "./chunk-KQUXNUPR.js";
import "./chunk-LTIWWQCC.js";
import "./chunk-CGOYXHZA.js";
import "./chunk-T337OBIR.js";
import "./chunk-KEGSGOKU.js";
import {
  h as h3,
  p as p2
} from "./chunk-E4R3EL2H.js";
import {
  p
} from "./chunk-OLDH52BF.js";
import "./chunk-PHNIZQVV.js";
...
import "./chunk-GKLYXZTC.js";
import "./chunk-KDWSKM5Q.js";
import "./chunk-EK7HOTRR.js";
import "./chunk-7BFKRZ2G.js";
import "./chunk-4XGBGEF6.js";
...
import "./chunk-2CNPQHTP.js";
import "./chunk-FH3AFJHN.js";
import "./chunk-4EDAZW2A.js";
import "./chunk-W5KVGWPO.js";
import "./chunk-WE2AHQJR.js";
import "./chunk-MRINPQEK.js";
import {
  A,
  h as h2
} from "./chunk-4WQJZMFU.js";
import "./chunk-BKDXEBHY.js";
import "./chunk-B5A4L35M.js";
import "./chunk-52SEOH5H.js";
import "./chunk-R54ZQNYY.js";
...
import "./chunk-YSZYDNWY.js";
import "./chunk-EPNZCXHU.js";
import "./chunk-OQM223YI.js";
import "./chunk-X65FCMKD.js";
...
import "./chunk-ZUKUBL6I.js";
import "./chunk-U6QATIIU.js";
import "./chunk-2SLWYL7O.js";
import "./chunk-FDNIDZRO.js";
import "./chunk-7YH7T6CS.js";
import "./chunk-R2DLN522.js";
import "./chunk-ABJ4G7M4.js";
...
import "./chunk-2DTXA4YW.js";
import "./chunk-LBQ5ZTFT.js";
import "./chunk-QYCN3DUD.js";
...
var x2 = class extends e {
  constructor(r3) {
    super(), this.element = r3, this._handles = new r2(), this.isWrapAround = false, this.perspectiveTransform = n(), this.wrapAroundShift = 0, this.clipGeometry = null, this._handles.add(f(() => this.element, () => {
  ...
  _getFrameControlPoints() {
    const t = this.groundControlPoints, e2 = t == null ? void 0 : t.length;
    if (!e2) return [];
...
var O2 = class extends b(d) {
  ...
  initialize() {
    ...
    this._sensorLocationSymbolType = (_a = this.layer) == null ? void 0 : _a.sensorSymbol.type, this._graphicsLayer.graphics.addMany([this._frameCenterGraphic, this._frameOutlineGraphic, this._sensorLocationGraphic, this._sensorSightlineGraphic, this._sensorTrailGraphic]), this.visibleTelemetryElements = new p2({ frame: ((_b = this.layer.telemetryDisplay) == null ? void 0 : _b.frame) ?? false, frameCenter: ((_c = this.layer.telemetryDisplay) == null ? void 0 : _c.frameCenter) ?? true, frameOutline: ((_d = this.layer.telemetryDisplay) == null ? void 0 : _d.frameOutline) ?? true, lineOfSight: ((_e = this.layer.telemetryDisplay) == null ? void 0 : _e.lineOfSight) ?? true, sensorLocation: ((_f = this.layer.telemetryDisplay) == null ? void 0 : _f.sensorLocation) ?? true, sensorTrail: ((_g = this.layer.telemetryDisplay) == null ? void 0 : _g.sensorTrail) ?? true });
  }
  attach() {
    ...
    }, () => this._updateVisibleTelemetryElements(), h), l(() => {
      var _a, _b, _c, _d, _e;
    ...
    }, () => this._updateGraphicGeometries(), h), l(() => this.layer.metadata, () => this._updateSensorLocationSymbolAngle(), h), l(() => {
      var _a;
      return (_a = this.layer) == null ? void 0 : _a.frameCenterSymbol;
    }, () => this._updateFrameCenterSymbol(), h), l(() => {
      var _a;
      return (_a = this.layer) == null ? void 0 : _a.frameOutlineSymbol;
    }, () => this._updateFrameOutlineSymbol(), h), l(() => {
      var _a;
      return (_a = this.layer) == null ? void 0 : _a.sensorSightLineSymbol;
    }, () => this._updateSensorSightlineSymbol(), h), l(() => {
      var _a;
      return (_a = this.layer) == null ? void 0 : _a.sensorSymbol;
    }, () => this._updateSensorLocationSymbol(), h), l(() => {
      var _a;
      return (_a = this.layer) == null ? void 0 : _a.sensorTrailSymbol;
    }, () => this._updateSensorTrailSymbol(), h), l(() => this.symbolAngle, () => this._updateSensorLocationSymbol(), h)]);
  }
  detach() {
  ...
  _updateSensorLocationSymbolAngle() {
    ...
    if (!this.view.animationsEnabled) return;
    if (!((_b = (_a = this.layer) == null ? void 0 : _a.metadata) == null ? void 0 : _b.size)) return;
    const { source: e2, symbolOffset: i3 = 0 } = this.layer.sensorSymbolOrientation || {};
    if (!e2 && !i3) return;
    const t = ((_e = (_d = (_c = this.layer) == null ? void 0 : _c.metadata) == null ? void 0 : _d.get(w)) == null ? void 0 : _e.value) ?? 0, s = ((_h = (_g = (_f = this.layer) == null ? void 0 : _f.metadata) == null ? void 0 : _g.get(T)) == null ? void 0 : _h.value) ?? 0, r3 = h3({ cameraAzimuth: s, platformHeading: t, source: (_i = this.layer.sensorSymbolOrientation) == null ? void 0 : _i.source, symbolOffset: ((_j = this.layer.sensorSymbolOrientation) == null ? void 0 : _j.symbolOffset) ?? 0 });
  ...
  _updateFrameCenterSymbol() {
    var _a;
    ((_a = this.layer) == null ? void 0 : _a.frameCenterSymbol) && (this._frameCenterGraphic.symbol = this.layer.frameCenterSymbol.clone());
  }
  _updateFrameOutlineSymbol() {
    var _a;
    ((_a = this.layer) == null ? void 0 : _a.frameOutlineSymbol) && (this._frameOutlineGraphic.symbol = this.layer.frameOutlineSymbol.clone());
  }
  _updateSensorSightlineSymbol() {
    var _a;
    ((_a = this.layer) == null ? void 0 : _a.sensorSightLineSymbol) && (this._sensorSightlineGraphic.symbol = this.layer.sensorSightLineSymbol.clone());
  }
  _updateSensorTrailSymbol() {
    var _a;
    ((_a = this.layer) == null ? void 0 : _a.sensorTrailSymbol) && (this._sensorTrailGraphic.symbol = this.layer.sensorTrailSymbol.clone());
  }
  async _addOverlayMultipoint() {
    ...
    this.addAttachHandles([l(() => {
      var _a;
      return [this.layer.frameHorizonPoints, this.layer.groundControlPoints, this.layer.frameOpacity, (_a = this.layer.telemetryDisplay) == null ? void 0 : _a.frame];
    }, () => {
      if (!this.view.animationsEnabled) return;
      const { visibleTelemetryElements: i3 } = this;
      e2.frameHorizonPoints = this.layer.frameHorizonPoints, e2.groundControlPoints = this.layer.groundControlPoints, e2.opacity = this.layer.frameOpacity, e2.visible = (i3 == null ? void 0 : i3.frame) ?? false;
...
//# sourceMappingURL=VideoLayerView2D-7MOJIB37.js.map
