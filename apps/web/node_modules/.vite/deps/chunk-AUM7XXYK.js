  ...
  switch (e11) {
    ...
    case "feature-record-set-layer":
      ...
      if ("layerDefinition" in t19) {
        const e12 = new (0, (await import("./FeatureLayer-F5DD2TUG.js")).default)(), { layerDefinition: a8, featureSet: n6 } = t19;
...
var g3 = (_a = class extends n2 {
  ...
  async fetchResultMapImageLayer() {
    ...
    return new (0, (await import("./MapImageLayer-4YQQXHNQ.js")).default)({ url: t19 });
  }
...
async function o5(s18) {
  if (s18) {
    const { default: s19 } = await import("./arcgis-knowledge-client-core-simd-RDANER2U.js").then((e11) => e11.a);
    return s19({ locateFile: (s20) => n(t5 + s20) });
  }
  const { default: r6 } = await import("./arcgis-knowledge-client-core-GKXTSOY5.js").then((e11) => e11.a);
...
//# sourceMappingURL=chunk-AUM7XXYK.js.map
