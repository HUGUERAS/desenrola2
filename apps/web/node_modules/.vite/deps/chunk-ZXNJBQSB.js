...
var g = class extends h {
  ...
  async _queryBuddy(e) {
    var _a;
    const t = new (await import("./FeatureLayer-F5DD2TUG.js")).default({ url: e }), { capabilities: r2 } = await t.load(), i3 = r2.query.supportsMaxRecordCountFactor, o3 = r2.query.supportsPagination, s2 = r2.query.supportsCentroid, n = this._config.maxRecordCountFactor, c = t.capabilities.query.maxRecordCount, u = i3 ? c * n : c, h3 = new b();
...
//# sourceMappingURL=chunk-ZXNJBQSB.js.map
