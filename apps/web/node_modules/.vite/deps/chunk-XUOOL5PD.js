...
var G = class extends u {
  ...
  async uploadAssets(e2, t3) {
    const { uploadAssets: r2 } = await import("./uploadAssets-3ZJWJYPH.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(e2) {
    ...
    for (const i5 of t3) {
      ...
      if (t(t4)) s4.push(e3);
        ...
        const t5 = e3.origin, { convertMeshVertexSpace: r3 } = await import("./convertMeshVertexSpace-WTJG7VBH.js"), n = await r3(e3, new i2({ origin: [t5.x, t5.y, t5.z ?? 0] }));
...
//# sourceMappingURL=chunk-XUOOL5PD.js.map
