...
async function G2() {
  has("host-webworker") && (!M2 && globalThis.invokeStaticMessage ? M2 = await import("./request-HODAXFED.js") : R3 = true);
}
async function J2() {
  s4 || await import("./IdentityManager-TRDKT44O.js");
}
...
async function te(e5) {
  ...
  if (!r4) return se(e5);
  const { QueueProcessor: t5 } = await import("./QueueProcessor-BL2RUUAP.js"), s5 = e(re, r4.origin, () => {
...
//# sourceMappingURL=chunk-NH3MPC3S.js.map
