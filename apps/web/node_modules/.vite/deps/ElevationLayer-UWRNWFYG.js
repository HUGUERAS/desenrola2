import {
  p
} from "./chunk-CVKEAM63.js";
import "./chunk-QXD2T26B.js";
import "./chunk-4WS333UE.js";
import {
  o as o2
...
var S = class extends p(l2(b(j(l(b2))))) {
  ...
  async queryElevation(e, r2) {
    const { query: t3 } = await import("./ElevationQuery-L25MBSFG.js");
    return s2(r2), t3(this, e, r2);
  }
  async createElevationSampler(e, r2) {
    const { createSampler: t3 } = await import("./ElevationQuery-L25MBSFG.js");
    return s2(r2), t3(this, e, r2);
  }
...
//# sourceMappingURL=ElevationLayer-UWRNWFYG.js.map
