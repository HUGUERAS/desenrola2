...
var j = (j2) => {
  ...
  let b = class extends _2 {
    ...
    async loadFromPortal(e, t) {
      ...
      if ((_a = this.portalItem) == null ? void 0 : _a.id) try {
        const { load: r2 } = await import("./layersLoader-6QP5WUDW.js");
  ...
  ${r2}`), r2;
    ...
    async _fetchUserPrivileges(e, t) {
      ...
      const i2 = !((_a = s3) == null ? void 0 : _a.findCredential(this.url)), o2 = e === s5.id;
      ...
      try {
        ...
        l = await ((_b = s3) == null ? void 0 : _b.getCredential(`${a2}/sharing`, { prompt: false, signal: e2 }));
      } catch (m2) {
        f(m2);
      }
    ...
    async _fetchUserHasEditingPrivileges(e) {
      var _a;
      const t = this.url ? (_a = s3) == null ? void 0 : _a.findCredential(this.url) : null;
      if (!t) return true;
    ...
    async _fetchEditingUser(e) {
      ...
      if (t) return t;
      const o2 = (_c = s3) == null ? void 0 : _c.findServerInfo(this.url ?? "");
...
//# sourceMappingURL=chunk-OGVOWCSG.js.map
