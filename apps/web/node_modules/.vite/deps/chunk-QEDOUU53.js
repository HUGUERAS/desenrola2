...
import {
  i as i9
} from "./chunk-J6TMVCZK.js";
import {
  a as a5
} from "./chunk-ZI7DMMQL.js";
import {
  r as r5
...
import {
  ...
  x2,
  z as z2
} from "./chunk-FEFBXLLP.js";
import {
  i as i8
} from "./chunk-DA73BRVZ.js";
import {
  b as b6
...
import {
  b as b4
} from "./chunk-ISA6GBAU.js";
import {
  a as a6
} from "./chunk-KQUXNUPR.js";
import {
  y as y3
} from "./chunk-KEGSGOKU.js";
import {
  E
...
import {
  p2 as p4
} from "./chunk-Y4HEHWLW.js";
import {
  e as e3,
  u as u7
} from "./chunk-VMWZQQ2H.js";
import {
  t as t2
...
import {
  ...
  Y,
  a as a4
} from "./chunk-5EOQ24FP.js";
import {
  i as i5
} from "./chunk-QHTO4JEO.js";
import {
  p as p3
} from "./chunk-UP6N2PCG.js";
import {
  d as d2
} from "./chunk-XSTUXOQT.js";
import {
  n as n3
} from "./chunk-HTJWTX3Q.js";
import {
  c
} from "./chunk-SMCKTUCN.js";
import {
  u as u6
...
import {
  J,
  W
} from "./chunk-SPGXDC7Y.js";
import {
  i as i6
} from "./chunk-YBRK74EF.js";
import {
  T
} from "./chunk-T4Q7VOVW.js";
import {
  g as g2
} from "./chunk-JAO4MJK4.js";
import {
  p as p2,
  y as y2
} from "./chunk-IH3THIWQ.js";
import {
  f as f2
...
async function o9(e13, a10, o14) {
  const r12 = a10.labelsVisible && a10.labelingInfo || [], i16 = e6(a10), t11 = c(r12, i16);
...
var p10 = class {
  ...
  _createServiceInfo(i16) {
    var _a, _b;
    const s14 = this.layer, { capabilities: a10, editingInfo: o14, objectIdField: l11, globalIdField: n14, datesInUnknownTimezone: p12, dateFieldsTimeZone: d10, orderBy: u17, parsedUrl: c9 } = s14, y7 = s14.fieldsIndex.toJSON(), m13 = e6(s14), f8 = (_a = s14.timeInfo) == null ? void 0 : _a.toJSON(), h4 = s14.spatialReference.toJSON(), g4 = a(c9);
    let b8 = l11;
...
var f6 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const r12 = this.layer, t11 = r7(r12, e13) ?? l8(r12), s14 = e5(r12, e13), a10 = [...r12.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  getUpdateHashProperties(e13) {
    return this.layer.destroyed ? [] : [() => this.layer.apiKey, () => this.layer.customParameters, () => this.layer.definitionExpression, () => e5(this.layer, e13), () => o12(this.layer, e13) ? e13.floors : null, () => this.layer.gdbVersion, () => this.layer.historicMoment, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => this.layer.orderBy, () => this.layer.outFields, () => this.layer.renderer, () => this.layer.subtypeCode, () => this.layer.trackInfo];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
  ...
  _createServiceInfo(r12) {
    var _a, _b, _c, _d;
    const i16 = this.layer, { capabilities: a10, editingInfo: o14, typeIdField: n14, globalIdField: y7, datesInUnknownTimezone: p12, dateFieldsTimeZone: d10, orderBy: c9, subtypeField: u17 } = i16, m13 = i16.fieldsIndex.toJSON(), h4 = e6(i16), f8 = (_a = i16.timeInfo) == null ? void 0 : _a.toJSON(), g4 = i16.spatialReference.toJSON(), b8 = (_b = i16.types) == null ? void 0 : _b.map((e13) => e13.toJSON()), I2 = a(this.layer.parsedUrl);
...
var p11 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const t11 = this.layer, n14 = r7(t11, e13) ?? l8(t11), s14 = e5(t11, e13), l11 = [...t11.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.definitionExpression, () => this.layer.displayFilterInfo, () => this.layer.orderBy, () => "outFields" in this.layer ? this.layer.outFields : null, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e5(this.layer, e13), () => "trackInfo" in this.layer ? this.layer.trackInfo : null];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
  ...
  _createServiceInfo(e13) {
    var _a;
    const r12 = this.layer, { capabilities: i16, objectIdField: o14 } = r12, a10 = r12.fieldsIndex.toJSON(), n14 = e6(r12), s14 = (_a = r12.timeInfo) == null ? void 0 : _a.toJSON(), l11 = r12.spatialReference.toJSON();
    c8(r12.source);
...
var d8 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.definitionExpression, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e5(this.layer, e13), () => y5(this.layer)];
  }
  hasFilters(e13) {
  ...
  _createServiceInfo(e13) {
    var _a;
    const r12 = this.layer, { capabilities: t11, objectIdField: i16 } = r12, s14 = r12.fieldsIndex.toJSON(), o14 = e6(r12), n14 = r12.spatialReference.toJSON(), l11 = i16, p12 = e13.spatialReference.toJSON();
...
var u15 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.apiKey, () => this.layer.customParameters, () => e5(this.layer, e13), () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => this.layer.orderBy, () => this.layer.renderer];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
  ...
  _createServiceInfo(r12) {
    var _a;
    const i16 = this.layer, { capabilities: a10 } = i16, o14 = i16.fieldsIndex.toJSON(), s14 = e6(i16), l11 = (_a = i16.timeInfo) == null ? void 0 : _a.toJSON(), n14 = i16.spatialReference.toJSON(), c9 = i16.source.getSource(), u17 = this.layer.objectIdField, p12 = a(a10);
...
var m12 = class {
  ...
  getUpdateHashProperties(e13) {
    return [() => this.layer.outFields, () => this.layer.orderBy, () => this.layer.definitionExpression, () => this.layer.renderer, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e5(this.layer, e13), () => this.layer.customParameters, () => o12(this.layer, e13) ? e13.floors : null];
  }
  setGraphicOrigin(e13) {
    e13.origin = this.layer.graphicOrigin;
  }
  ...
  _createServiceInfo(t11) {
    var _a;
    const i16 = this.layer, { capabilities: s14, globalIdField: o14, orderBy: l11 } = i16, n14 = i16.fieldsIndex.toJSON(), d10 = e6(i16), p12 = (_a = i16.timeInfo) == null ? void 0 : _a.toJSON(), c9 = i16.spatialReference.toJSON(), u17 = a(this.layer.parsedUrl);
...
var y6 = class {
  ...
  getLabelingDeconflictionInfo(e13) {
    const r12 = this.layer, i16 = r7(r12, e13) ?? l8(r12), n14 = e5(r12, e13), o14 = [...r12.labelingInfo || [], ...(n14 == null ? void 0 : n14.labelingInfo) || []];
    return [{ vvEvaluators: { 0: o7(r12.renderer) }, deconflictionEnabled: i16, labelingInfo: o14 }];
  }
  getUpdateHashProperties(e13) {
    return [() => this.layer.urls.join(","), () => this.layer.outFields, () => this.layer.labelsVisible ? this.layer.labelingInfo : null, () => e5(this.layer, e13), () => this.layer.customParameters, () => this.layer.orderBy, () => this.layer.renderer, () => this.layer.popupTemplate];
  }
  async createSourceSchema(e13, r12) {
  ...
  _createServiceInfo(t11) {
    const l11 = e6(this.layer), a10 = t11.spatialReference.toJSON(), s14 = this.layer.encoding;
...
var s12 = class {
  ...
  getLabelingDeconflictionInfo(r12) {
    const a10 = this.layer, n14 = r7(a10, r12) ?? l8(a10), s14 = e5(a10, r12), o14 = [...a10.labelingInfo || [], ...(s14 == null ? void 0 : s14.labelingInfo) || []];
  ...
  _createServiceInfo(e13) {
    var _a;
    const t11 = e6(this.layer), i16 = ((_a = this.layer.timeInfo) == null ? void 0 : _a.toJSON()) || null, l11 = this.layer.spatialReference ? this.layer.spatialReference.toJSON() : null, a10 = e13.spatialReference.toJSON();
...
//# sourceMappingURL=chunk-QEDOUU53.js.map
