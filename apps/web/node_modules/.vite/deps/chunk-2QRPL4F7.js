...
import {
  a as a4
} from "./chunk-PZQ747ZV.js";
import {
  e
} from "./chunk-DWU76XVD.js";
import {
  n
...
var b = I = (_a = class extends a3(u2) {
  ...
  async queryElevation(r4, e2) {
    ...
    const { queryAll: o3 } = await import("./ElevationQuery-L25MBSFG.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  async createElevationSampler(r4, e2) {
    await this.load({ signal: e2 == null ? void 0 : e2.signal });
    const { createSampler: o3 } = await import("./ElevationQuery-L25MBSFG.js");
    s2(e2);
    return o3(this.layers.filter(A).toArray(), r4, e2);
  }
  clone() {
  ...
  async _loadLayersFromJSON(r4, e2, o3) {
    const t3 = (e2 == null ? void 0 : e2.origin) || "web-scene", s4 = (e2 == null ? void 0 : e2.portal) || null, a6 = (e2 == null ? void 0 : e2.url) || null, { populateOperationalLayers: i5 } = await import("./layersCreator-TE7X77WB.js");
    s2(o3);
    const n8 = [];
...
//# sourceMappingURL=chunk-2QRPL4F7.js.map
