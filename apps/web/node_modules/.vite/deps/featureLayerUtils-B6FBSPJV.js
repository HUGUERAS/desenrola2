...
async function H(e) {
  ...
  e.forEach(({ type: e2 }) => {
    switch (l2(e2)) {
      case "CatalogLayer":
        r.push(import("./CatalogLayer-FYX27X6I.js").then((e3) => e3.default));
        break;
      case "FeatureLayer":
        r.push(import("./FeatureLayer-F5DD2TUG.js").then((e3) => e3.default));
        break;
      case "OrientedImageryLayer":
        r.push(import("./OrientedImageryLayer-RX7V2PX3.js").then((e3) => e3.default));
    }
  });
...
//# sourceMappingURL=featureLayerUtils-B6FBSPJV.js.map
